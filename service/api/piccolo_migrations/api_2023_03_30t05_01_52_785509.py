...
class CoBranch(Table, tablename="co_branch"):
    branch_id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
class HrJobStatus(Table, tablename="hr_job_status"):
...
class HrMarriageStatus(Table, tablename="hr_marriage_status"):
    marriage_status_id = Serial(
        null=False,
        primary_key=True,
        unique=False,
        index=True,
...
class HrOccupation(Table, tablename="hr_occupation"):
...
ID = "2023-03-30T05:01:52:785509"
VERSION = "0.109.0"
DESCRIPTION = "Add hr_employee"
...
async def forwards():
    ...
    manager.add_table("HrEmployee", tablename="hr_employee")
    ...
    manager.add_column(
        table_class_name="HrEmployee",
        tablename="hr_employee",
        column_name="begin_job",
        db_column_name="begin_job",
        column_class_name="Date",
        column_class=Date,
        params={
            "default": DateNow(),
